...
Hi,
I recently applied for the AI Operations Intern role and wanted to share a project I think is directly relevant. During my Mathematics degree at UC Irvine, I built a Premier League fantasy football optimisation model — training XGBoost and other regression models on historical player data to predict points, then using constrained optimisation to assemble the highest-scoring squad within budget and positional limits.
